...
import { Disc3, Plus, LogIn, LogOut, User as UserIcon, Search } from 'lucide-react';
          ...
          {isAuthenticated ? (
            <>
              <button
                ...
                className="group relative inline-flex items-center gap-2 rounded-xl bg-amber-500 px-4 py-2.5 text-sm font-semibold text-zinc-950 shadow-md shadow-amber-500/20 transition-all hover:bg-amber-400 hover:shadow-amber-500/30 active:scale-95"
              >
